...
//  private class SecondDegreePolynomialImpl(val secondDegree: Double, val firstDegree: Double, val constant: Double)
...
case class SecondDegreePolynomialImpl(secondDegree: Double, firstDegree: Double, constant: Double)
  extends SecondDegreePolynomial:
  override def +(polynomial: SecondDegreePolynomial): SecondDegreePolynomial =
    SecondDegreePolynomial(secondDegree + polynomial.secondDegree, firstDegree + polynomial.firstDegree, constant + polynomial.constant)
 ...
 */
@main def checkToStringAndEquality(): Unit =
  val simplePolynomial = SecondDegreePolynomial(1.0, 0, 3)
  val equalPolynomial = SecondDegreePolynomial(1.0, 0, 3)
  // Check equality
  println(simplePolynomial == equalPolynomial)
  // Check toString
  println(simplePolynomial)